...
//    urlBuilder.append("?" + URLEncoder.encode("ServiceKey","UTF-8") + "=서비스키"); /*Service Key*/
    urlBuilder.append("&" + URLEncoder.encode("ServiceKey","UTF-8") + "=" + URLEncoder.encode("LG18%2Bl1kJLaRFCBxW4r9u0kHmv2895qaNwhUJy9%2BObPzVMT%2BG5XElRSHZ5Au4WPKhe0HhD2fejkrfMp3Ke%2FDwQ%3D%3D", "UTF-8")); /*공공데이터포털에서 발급받은 인증키*/
